...
const MentorMeetings = () => {
    ...
    const getMeetings = async () => {
        try {
            let regnotesting = '43111124'
            const response = await axios.get(`${serverPath1}/get_meetings/${regnotesting}`);
            ...
            if (error.response && error.response.status === 404) {
                setMessages("No meetings found for this registration number");
              } else {
