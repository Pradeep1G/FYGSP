                ...
                <form>
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <div className="w-full sm:w-1/2 mb-4 ">
                      ...
                      <label className="block text-sm font-semibold pr-1 text-gray-600 px-7">Name</label>
                      <TextareaAutosize name="name" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" style={{ resize: 'none', overflow: 'hidden' }} value={personaldetails.length > 0 ? capitalizeEachWord(personaldetails[0].name) : ''}  />
                    </div>

                    {/* Second column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold pr-1 text-gray-600 px-7">Department Name</label>
                      <input name="dep" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={personaldetails.length > 0 ? capitalizeString(personaldetails[0].dep) : ''} />
                    </div>

                    {/* Third column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold  text-gray-600 px-7">Section</label>
                      <input name="section" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={personaldetails.length > 0 ? capitalizeEachWord(personaldetails[0].section) : ''}/>
                    </div>

                    {/* Fourth column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold  text-gray-600 px-7">Register Number</label>
                      <input name="regNo" readOnly type="text" className="lg:w-2/4 w-4/5 mx-6  border rounded-md px-3 py-2" value={personaldetails.length > 0 ? personaldetails[0].regNo : ''}  />
                    </div>

                    {/* Fifth column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold  text-gray-600 px-7">Religion</label>
                      <input name="religion" readOnly type="text" className="lg:w-2/4 w-4/5  mx-7 border rounded-md px-3 py-2" value={personaldetails.length > 0 ? capitalizeEachWord(personaldetails[0].religion) : ''}/>
                    </div>

                    {/* Sixth column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold text-gray-600 px-7">Community</label>
                      <input name="community" readOnly type="text" className="lg:w-2/4 w-4/5  border rounded-md  mx-6 px-3 py-2" value={personaldetails.length > 0 ? capitalizeString(personaldetails[0].community) : ''}  />
                    </div>

                    {/* Seventh column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold text-gray-600 px-7">Life Goal</label>
                      <input name="lifeGoal" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={personaldetails.length > 0 ? capitalizeEachWord(personaldetails[0].lifeGoal) : ''}  />
                    </div>

                    {/* Eighth column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold  text-gray-600 px-7">Blood Group</label>
                      <input name="bloodGrp" readOnly type="text" className="lg:w-2/4 mx-6 w-4/5 border rounded-md px-3 py-2" value={personaldetails.length > 0 ? capitalizeEachWord(personaldetails[0].bloodGrp) : ''} />
                    </div>
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold  text-gray-600 px-7">Languages Known</label>
                      <input name="languages" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={personaldetails.length > 0 ? capitalizeEachWord(personaldetails[0].languages) : ''} />
                    </div>
                  </div>
                  <div>
                  </div>
                  ...
                  <div className="rounded-xl lg:w-3/4 md:w-full px-4 bg-gray-100 p-4 mx-auto mb-5">
                    <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="w-full lg:w-1/2 mb-4">
                        {/* First detail */}
                        <div className="w-full sm:w-3/4 mt-4 mb-2">
                          <label className="block text-sm font-semibold  text-gray-600 px-8">Father's Name</label>
                          <TextareaAutosize name="fatherName" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" style={{ resize: 'none', overflow: 'hidden'}} value={parentdetails.length > 0 ? capitalizeEachWord(parentdetails[0].fatherName) : ''} />
                        </div>

                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm font-semibold  text-gray-600 px-8">Father's EmailId</label>
                          <input name="fatherMail" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? parentdetails[0].fatherMail : ''} />
                        </div>

                        {/* Second detail */}
                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm font-semibold  text-gray-600 px-8">Phone Number</label>
                          <input name="fatherNo" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? parentdetails[0].fatherNo : ''} 
                       />
                        </div>

                        {/* Third detail */}
                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm font-semibold text-gray-600 px-8">Occupation</label>
                          <input name="fatherOcc" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? capitalizeEachWord(parentdetails[0].fatherOcc) : ''} />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl lg:w-3/4 md:w-full px-4 bg-gray-100 p-4 mx-auto mb-5">
                    <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="w-full lg:w-1/2 mb-2">
                        {/* First detail */}
                        <div className="w-full sm:w-3/4 mt-4 mb-2">
                          <label className="block text-sm font-semibold px-8 text-gray-600">Mother's Name</label>
                          <TextareaAutosize name="motherName" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" style={{ resize: 'none', overflow: 'hidden' }} value={parentdetails.length > 0 ? capitalizeEachWord(parentdetails[0].motherName) : ''} />
                        </div>

                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm font-semibold px-8 text-gray-600">Mother's EmailId</label>
                          <input name="motherMail" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? parentdetails[0].motherMail : ''} />
                        </div>

                        {/* Second detail */}
                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm px-8 font-semibold text-gray-600">Phone Number</label>
                          <input name="motherNo" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? parentdetails[0].motherNo : ''}  />
                        </div>

                        {/* Third detail */}
                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm px-8 font-semibold text-gray-600">Occupation</label>
                          <input name="motherOcc" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? capitalizeEachWord(parentdetails[0].motherOcc) : ''} />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl lg:w-3/4 md:w-full px-4 bg-gray-100 p-4 mx-auto mb-5">
                    <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="w-full lg:w-1/2 mb-2">
                        {/* First detail */}
                        <div className="w-full sm:w-3/4 mt-4 mb-4">
                          <label className="block text-sm font-semibold px-8 text-gray-600">Guardian's Name</label>
                          <TextareaAutosize name="guardianName" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" style={{ resize: 'none', overflow: 'hidden' }} value={parentdetails.length > 0 ? capitalizeEachWord(parentdetails[0].guardianName) : ''} />
                        </div>

                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm font-semibold px-8 text-gray-600">Guardian's EmailId</label>
                          <input name="guardianMail" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? parentdetails[0].guardianMail : ''} />
                        </div>

                        {/* Second detail */}
                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm px-8 font-semibold text-gray-600">Phone Number</label>
                          <input name="guardianNo" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? parentdetails[0].guardianNo : ''}  />
                        </div>
                        <div className="w-full sm:w-3/4 mb-2">
                          <label className="block text-sm px-8 font-semibold text-gray-600">Occupation</label>
                          <input name="guardianOcc" readOnly type="text" className="lg:w-full mx-7 w-4/5 border rounded-md px-3 py-2" value={parentdetails.length > 0 ? capitalizeEachWord(parentdetails[0].guardianOcc) : ''}  />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <form>
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="w-full sm:w-3/4 mb-4">
                      ...
                      <TextareaAutosize name="permanentAdd" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" style={{ resize: 'none', overflow: 'hidden' }} value={address.length > 0 ? capitalizeEachWord(address[0].permanentAdd) : ''}  />
                    </div>
                    ...
                    <div className="flex flex-row items-start justify-start flex-wrap sm:flex-col  sm:justify-start md:flex-row">
                      <div className="w-full sm:w-3/4 mb-4">
                        ...
                        <TextareaAutosize name="communicationAdd" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" style={{ resize: 'none', overflow: 'hidden' }} value={address.length > 0 ? capitalizeEachWord(address[0].communicationAdd) : ''} />
                        { address[0]?.hostelName && address[0]?.hostelNo && < label className="block text-sm  pt-3 px-8 font-bold">Hostel Details</label>         }
   <div className="mt-4">
    ...
    <div className="mb-2">
      ...
      />
                    ...
                    <div className="flex flex-row items-start justify-start flex-wrap sm:flex-col sm:justify-start md:flex-row">
                      ...
                      <div className="w-full sm:w-1/2 mb-4">
                        <label className="block text-sm font-semibold px-8 text-gray-600">Number</label>
                        <input name="phoneNo" readOnly  type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={address.length > 0 ? address[0].phoneNo : ''}  />
                      </div>

                      <div className="w-full sm:w-1/2 mb-4">
                        <label className="block text-sm font-semibold px-8 text-gray-600">Alternative Number</label>
                        <input name="alterNo" readOnly  type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={address.length > 0 ? address[0].alterNo : ''}
                        />
                      </div>
                    </div>
                  </div>
                ...
                <form>
                  ...
                  <div className="">
                    ...
                    {/* Second column */}
                    <div className="w-full sm:w-1/2 mb-4">
                      <label className="block text-sm font-semibold px-8 text-gray-600">12th Previous Institution Name</label>
                      <TextareaAutosize name="previousInst" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" style={{ resize: 'none', overflow: 'hidden' }} value={academicdetails.length > 0 ? capitalizeEachWord(academicdetails[0].previousInst) : ''} />
                    </div>
                    <div className='flex flex-wrap'>
                      {/* Third column */}
                      <div className="w-full sm:w-1/2 mb-4">
                        <label className="block text-sm font-semibold px-8 text-gray-600">10th Percentage</label>
                        <input name="tenthper" readOnly type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={academicdetails.length > 0 ? academicdetails[0].tenthper : ''}  />
                      </div>

                      {/* Fourth column */}
                      <div className="w-full sm:w-1/2 mb-4">
                        <label className="block text-sm font-semibold px-8 text-gray-600">12th Percentage</label>
                        <input name="twelfthper" readOnly  type="text" className="lg:w-2/4 mx-7 w-4/5 border rounded-md px-3 py-2" value={academicdetails.length > 0 ? academicdetails[0].twelfthper : ''}  />
                      </div>
                    </div>
                  </div>
                  <div>
